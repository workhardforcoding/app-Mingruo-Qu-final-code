...
from resources.ShoppingResource import ShoppingCartResource
...
api.add_resource(ShoppingCartResource,
                 '/shoppingcart',
                 '/shoppingcart/',
                 '/shoppingcart/<string:customer_id>',
                 '/shoppingcart/<string:item_id>')
